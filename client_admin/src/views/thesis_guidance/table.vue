		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/thesis_guidance/table','add') || $check_action('/thesis_guidance/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/thesis_guidance/table','del') || $check_action('/thesis_guidance/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','document_type')" min-width="200">
					...
					<el-table-column prop="guidance_content" @sort-change="$sortChange" label="指导内容"
				v-if="user_group == '管理员' || $check_field('get','guidance_content')" min-width="200">
					</el-table-column>
					<el-table-column prop="guidance_document" @sort-change="$sortChange" label="指导文档"
				v-if="user_group == '管理员' || $check_field('get','guidance_document')" min-width="200">
						<template slot-scope="scope">
					<a :href="$fullUrl(scope.row['guidance_document'])" target="_blank" style="color: rgb(64, 158, 255);">点击下载</a>
				</template>
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/thesis_guidance/table','set') || $check_action('/thesis_guidance/view','set') || $check_action('/thesis_guidance/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/thesis_guidance/table','set') || $check_action('/thesis_guidance/view','set') || $check_action('/thesis_guidance/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/thesis_guidance/get_list?like=0",
				url_del: "~/api/thesis_guidance/del?",
