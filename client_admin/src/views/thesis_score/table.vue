		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/thesis_score/table','add') || $check_action('/thesis_score/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/thesis_score/table','del') || $check_action('/thesis_score/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','thesis_title')" min-width="200">
					...
					<el-table-column prop="thesis_score" @sort-change="$sortChange" label="论文成绩"
				v-if="user_group == '管理员' || $check_field('get','thesis_score')" min-width="200">
					</el-table-column>
					<el-table-column prop="note_details" @sort-change="$sortChange" label="备注详情"
				v-if="user_group == '管理员' || $check_field('get','note_details')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/thesis_score/table','set') || $check_action('/thesis_score/view','set') || $check_action('/thesis_score/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/thesis_score/table','set') || $check_action('/thesis_score/view','set') || $check_action('/thesis_score/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/thesis_score/get_list?like=0",
				url_del: "~/api/thesis_score/del?",
