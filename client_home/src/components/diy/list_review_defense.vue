<template>
	<div class="diy_home diy_list diy_review_defense" id="diy_review_defense_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/review_defense/details?review_defense_id=' + o['review_defense_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/review_defense/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/review_defense/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						论文题目
							...
							<th class="diy_title" v-if="$check_field('get','date_of_reply')">
						答辩日期
					</th>
							<th class="diy_title" v-if="$check_field('get','assessor')">
						评审人员
					</th>
							<th class="diy_title" v-if="$check_field('get','defense')">
						答辩情况
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_datetime" v-if="$check_field('get','date_of_reply')">
						<span>
							{{ $toTime(o["date_of_reply"] ,"yyyy-MM-dd hh:mm:ss") }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','assessor')">
						<span>
							{{ o["assessor"] }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','defense')">
						<span>
							{{ o["defense"] }}
						</span>
					</td>
