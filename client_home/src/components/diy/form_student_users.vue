<template>
	<div>
			<b-form-group v-if="$check_register_field('add','student_id','/student_users/view')" id="input-group-${idx}" label="学生学号" label-for="input-${idx}">
			<b-form-input id="input-${idx}" v-model="form['student_id']" type="text" placeholder="学生学号" trim></b-form-input>
		</b-form-group>
			...
			<b-form-input id="input-${idx}" v-model="form['class_name']" type="text" placeholder="班级名称" trim></b-form-input>
		</b-form-group>
		</div>
</template>
