<template>
	<div class="diy_details_box diy_div_thesis_title">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/thesis_document/edit','add')" @click="to_form('/thesis_document/edit')" > 上传文档 </button>
										<button class="btn btn-primary details_btn" v-if="$check_action('/tutor_answers_questions/edit','add')" @click="to_form('/tutor_answers_questions/edit')" > 留言提问 </button>
										</div>
						<!-- 富文本 -->
