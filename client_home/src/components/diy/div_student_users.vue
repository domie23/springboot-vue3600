			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/student_users/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			change_collect() {
				...
				var query = {
					...
					source_field: "student_users_id",
					source_id: this.obj["student_users_id"],
					user_id
				};
      ...
      check_collect() {
        ...
        var student_users_id = this.obj.student_users_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "student_users",
          source_field: "student_users_id",
          source_id: student_users_id
        }, (res) => {
